...
const ContactMethod: React.FC<ContactProps> = ({ img, text, link, info }) => {
  return (
    <a href={link} className="flex flex-col sm:flex-row items-center">
      ...
      <div className="flex flex-row sm:flex-col gap-1 sm:gap-0 mt-4 sm:mt-0 text-left sm:ml-4 my-auto">
        {text}
        <p className="text-green-400 active:text-green-700 inline-block hover:scale-110 transition-all hover:bg-neutral-700 hover:rotate-3">
          {info}
        </p>
      </div>
    </a>
